...
- Быстрый алгоритм создания хеша из звукового отвечатка звуковой дорожки для песен. И сделать на основе этого механизмы восстановления при изменении параметров файла и синхронизация на основе этого хеша
