...
pub struct TrackInfo {
    ...
    pub volume: f32,
    /// длительность трека в секундах (для прогресс-бара). 0 — неизвестна.
    pub duration: u64,
    /// путь к обложке трека (из бд), если есть — показывается на вкладке SONG.
    pub cover: Option<String>,
    /// путь к файлу трека на диске, если известен — показывается на вкладке SONG.
...
pub enum Control {
    ...
    /// перепроверить недействительный трек по его текущему пути (файл вернулся).
    RescanPath { id: i64 },
